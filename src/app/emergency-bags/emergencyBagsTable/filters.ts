...
const buildDateFilter = (initialState: DateRangeState): EmergencyBagsFilter<DateRangeState> => {
...
export const buildEmergencyBagFilters = async (
    ...
    const additionalFilters: EmergencyBagsFilters = [await buildLastStatusFilter()];
