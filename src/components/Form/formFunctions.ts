...
export enum Errors {
    ...
    unavailableCollectionDate = "The previous collection date is no longer available, please select a new collection date.",
    unavailableCollectionSlot = "The previous timeslot is no longer available, please select a new timeslot.",
