    ...
    batchDataRows: [
        {
            ...
            data: {
                client: {
                    ...
                    listType: "hotel",
                    cookingFacilities: { hob: true, oven: true },
        ...
        },
        {
            ...
            data: {
                client: {
                    ...
                    listType: "regular",
                    cookingFacilities: { kettle: true, "Air Fryer": true },
                    ...
                    signpostingCallReasons: { debt: true, housing: true },
                    notes: null,
                },
                clientReadOnly: false,
                parcel: getEmptyBatchEditData().parcel,
        ...
        },
        {
            ...
            data: {
                client: {
                    ...
                    listType: "regular",
                    cookingFacilities: { microwave: true, kettle: true },
                    dietaryRequirements: { "gluten-free": true },
                    babyProducts: "No",
                    nappySize: null,
                    petFood: { cat: true, dog: false },
                    ...
                    attentionFlag: false,
                    signpostingCall: true,
                    signpostingCallReasons: { benefits: true },
                    notes: null,
                },
                clientReadOnly: false,
                parcel: {
        ...
        },
        {
            ...
            data: {
                client: {
                    ...
                    listType: "regular",
                    cookingFacilities: { microwave: true, kettle: true, hob: true },
                    dietaryRequirements: { "gluten-free": true },
                    babyProducts: "No",
                    nappySize: null,
                    petFood: { cat: true, dog: false },
                    ...
                    attentionFlag: false,
                    signpostingCall: true,
                    signpostingCallReasons: { housing: true },
                    notes: null,
                },
                clientReadOnly: false,
                parcel: {
...
export const mockExistingClientRow: Schema["clients"] = {
    ...
    cooking_facilities: ["kettle"],
    hygiene_tampons: "2 packs",
    hygiene_pads: null,
    hygiene_other_items: ["female_incontinence_pads"],
    baby_food: null,
    baby_formula: null,
    baby_nappies: null,
    ...
    signposting_call_reasons: ["Cost of Living"],
...
export const mockExistingClientRowWithNappySize: Schema["clients"] = {
    ...
    dietary_requirements: ["vegan"],
    cooking_facilities: ["microwave", "toaster"],
    hygiene_tampons: null,
    hygiene_pads: null,
    hygiene_other_items: [],
    baby_food: "rusks",
    baby_formula: "Easy mix",
    baby_nappies: "Size 10",
    baby_other_items: ["wipes"],
    pet_food: ["dog"],
    other_items: ["toothpaste"],
    extra_information: "Nappies are useful",
    flagged_for_attention: false,
    signposting_call_required: true,
    signposting_call_reasons: ["Debt", "Housing"],
    last_updated: "2022-01-01",
    is_active: true,
    notes: null,
    default_list: "regular",
