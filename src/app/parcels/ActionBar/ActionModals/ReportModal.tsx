...
import ReportCsvButton, { FetchReportError } from "../ActionButtons/ReportCsvButton";
...
const ReportInput: React.FC<ReportInputProps> = (props) => {
    return (
        <InputContainer>
...
const ReportModal: React.FC<ActionModalProps> = (props) => {
